    ...
    <article className="group relative flex flex-col overflow-hidden rounded-2xl border border-border bg-white transition-all duration-300 hover:border-google-blue/30 hover:shadow-xl hover:shadow-google-blue/10">
      ...
      <div className="flex flex-1 flex-col p-4">
        <div className="mb-2 space-y-1.5">
          <ProductFilterTags product={product} />
        ...
        <div className="flex items-center justify-between mb-3">
          ...
          <button
            ...
            className="flex h-9 w-9 items-center justify-center rounded-full bg-google-blue text-white transition-all hover:bg-google-blue-dark hover:scale-105 shadow-sm"
        ...
        <div className="border-t border-border pt-3">
          <button
            ...
            className={cn(
              "flex w-full items-center justify-center gap-2 text-xs text-muted hover:text-google-blue transition-colors",
